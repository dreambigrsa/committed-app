...
This is the **Committed** cross-platform mobile app built with Expo Router + React Native.
...
# Step 4: Start the instant web preview in your browser, with auto-reloading of your changes
bun run start-web
...
You can test in Expo Go. You don't need XCode or Android Studio for most features.
...
- Visit [Expo's docs](https://docs.expo.dev/) for platform-specific questions
