...
| Realtime subscriptions | **Expo** `AppContext` realtime; web **not fully mirrored** |
...
2. **Realtime on web** — mirror critical `AppContext` channels where UX requires live updates.
